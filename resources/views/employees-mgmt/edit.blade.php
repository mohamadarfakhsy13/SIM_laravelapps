    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Update Staff Information</div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('employee-management.update', ['id' => $employee->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group{{ $errors->has('firstname') ? ' has-error' : '' }}">
                            <label for="firstname" class="col-md-4 control-label">Staff Name</label>
                        ...
                        <div class="form-group{{ $errors->has('ic_no') ? ' has-error' : '' }}">
                            <label for="ic_no" class="col-md-4 control-label">NRIC</label>

                            <div class="col-md-6">
                                <input id="ic_no" type="text" class="form-control" name="ic_no" value="{{ $employee->ic_no }}" required>
                        ...
                        <div class="form-group{{ $errors->has('phone_no') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="phone_no" type="text" class="form-control" name="phone_no" value="{{ $employee->phone_no }}" required>
