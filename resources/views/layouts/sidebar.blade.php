    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="{{ asset("/bower_components/AdminLTE/dist/img/hipster-avatar-man-mustache-beard.jpg") }}" class="img-circle" alt="User Image">
        </div>
      ...
      <ul class="sidebar-menu">
        <!-- Optionally, you can add hipster-avatar-man-mustache-beards to the links -->
        <li class="active"><a href="/dashboard"><i class="fa fa-link"></i> <span>Dashboard</span></a></li>
        <li><a href="{{ url('employee-management') }}"><i class="fa fa-link"></i> <span>Staff Information Management</span></a></li>
        <li class="treeview">
